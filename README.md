...
The computation-based application procedures of the study were conducted using the Python programming language in the Jupyter Notebook environment. During the code development process, open-source code repositories and extensions, such as Keras and TensorFlow, were utilized. Additionally, in the debugging and compilation stages of the developed code, the generative AI tool ChatGPT-4o (version: 2024-05-13) was employed in a limited capacity solely for technical support purposes. The generated outputs were verified for accuracy and used under full scientific responsibility.
